  ...
  return (
    <nav className="nav">
      <div className={`nav__container`}>
        ...
        <div
          className={`nav__hamburger ${navOpen ? "cross" : ""}`}
          onClick={navOpenHandler}
        >
          <div
            className={`line ${navOpen ? "clickCross secondLine" : ""}`}
          ></div>
          <div
            className={`line ${navOpen ? "clickCross firstLine" : ""}`}
          ></div>
          <div
            className={`line ${navOpen ? "clickCross thirdLine" : ""}`}
          ></div>
        </div>
        <ul
